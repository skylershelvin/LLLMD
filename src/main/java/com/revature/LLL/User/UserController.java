...
public class UserController {
     ...
     *
     * @param userId the ID of the user to retrieve
     * @param userType the type of the user making the request, which must be
     * "VET" to access this endpoint
     * @return a ResponseEntity containing the user if found and the requester
     * is authorized, or an appropriate error status
     ...
     * representing all owners if the requester is authorized, or an appropriate
     * error status
